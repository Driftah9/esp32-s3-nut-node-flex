/*============================================================================
 ...
 R15 v15.19 Fix Home Assistant NUT integration availability:
            - Add LOGIN handler (HA sends this after auth — was returning
              ERR INVALID-COMMAND causing HA to mark device unavailable)
            - Add LOGOUT handler
            - Increase NUT_RECV_TIMEOUT_S 5->30 to prevent spurious
              timeouts between HA command sequences
...
static const char *DEVICE_TYPE    = "ups";
static const char *BATTERY_TYPE   = "PbAc";
static const char *UPS_TYPE       = "line-interactive";
